  ...
  return (
    ...
    <div className="flex min-h-full flex-col overflow-y-auto lg:h-full lg:min-h-0 lg:flex-row lg:overflow-hidden">
      ...
      <div className="flex min-w-0 flex-1 flex-col lg:overflow-y-auto">
        ...
        {/* Header card */}
        <div className="relative flex min-h-[90px] shrink-0 flex-col items-start justify-end gap-3 overflow-hidden rounded-xl border p-4 sm:min-h-[100px] sm:p-5">
          {/* Background image */}
        ...
        {/* Sections + content */}
        <div className="flex min-h-0 flex-col gap-4 lg:flex-1 lg:flex-row lg:items-stretch lg:gap-5">
